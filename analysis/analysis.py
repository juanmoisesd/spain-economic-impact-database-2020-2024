# analysis.py — Spain Economic Impact Database (2020-2024)
...
keywords = ['Spain', 'macroeconomics', 'GDP', 'economic indicators', 'unemployment']
...
print(f"Dataset: Spain Economic Impact Database (2020-2024)")
print(f"DOI: 10.5281/zenodo.18826963")
...
fig.suptitle("Spain Economic Impact Database (2020-2024)", fontsize=11, fontweight="bold")
...
print(f"""
Citation:
de la Serna Tuya, Juan Moisés (2025). Spain Economic Impact Database (2020-2024). Zenodo. https://doi.org/10.5281/zenodo.18826963
""")
