# Spain Economic Impact Database (2020-2024)

[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.18826963.svg)](https://doi.org/10.5281/zenodo.18826963)
...
[![Pages](https://img.shields.io/badge/Live-Microsite-brightgreen)](https://juanmoisesd.github.io/spain-economic-impact-database-2020-2024/)

## Overview
This dataset compiles key macroeconomic and financial indicators for Spain covering the period 2020&ndash;2024. It includes five structured tables: (1) Macroeconomic Indicators (GDP growth, inflation, unemployment, trade balance, government deficit, public debt, and defense spending); (2) Financial Markets and Investment (IBEX 35 performance, EUR/USD exchange rate, and FDI inflows); (3) Tourism (i

## Dataset Status
| Field | Value |
|---|---|
| Status | 🟢 Published |
| DOI | [10.5281/zenodo.18826963](https://doi.org/10.5281/zenodo.18826963) |
| Platform | Zenodo |
| License | CC0 1.0 |
| Published | 2025-01-03 |

## 🌐 Interactive Microsite
**[Open Microsite](https://juanmoisesd.github.io/spain-economic-impact-database-2020-2024/)**

## Keywords
Spain, macroeconomics, GDP, economic indicators, unemployment, inflation, tourism, financial markets

## Citation
> de la Serna Tuya, J.M. (2025). *Spain Economic Impact Database (2020-2024)*. Zenodo. https://doi.org/10.5281/zenodo.18826963
...
**APA 7**
> De la Serna Tuya, J. M. (2025). *This dataset compiles key macroeconomic and financial indicators for Spain covering the period 2020&ndash;2024. It includes five structured tables: (1) Macroeconomic Indicators (GDP growth, inflation, unemployment, trade balance, government deficit, * [Dataset]. GitHub. https://github.com/juanmoisesd/spain-economic-impact-database-2020-2024

**BibTeX**
```bibtex
@dataset{delaserna2025_spain_economic_impact_database,
